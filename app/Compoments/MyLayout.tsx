...
import { Home, BarChart2, Users, Settings,CrossIcon } from "lucide-react";
...
export default function MyLayout({children}:{
 ...
 {
const {day,openSidebar,setopenSidebar} = useContext(MyContext);
...
const navItems = [
  ...
  return (
   <div className={`h-screen overflow-hidden text-white ${day ? "bg-[#F7F7F7]" : "bg-[#0d0d0d]" }  flex relative`}>
